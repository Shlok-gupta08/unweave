...
export const BottomTabBar: React.FC<BottomTabBarProps> = ({ activeTab, onTabChange }) => {
    ...
    return (
        ...
        >
            <div className="max-w-5xl mx-auto px-2 sm:px-6 h-14 sm:h-16 flex items-center justify-around overflow-x-auto custom-scrollbar">
                {tabs.map((tab) => {
                    ...
                    return (
                        <button
                            ...
                            className={`relative flex flex-row items-center justify-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-xl text-xs sm:text-sm font-semibold whitespace-nowrap shrink-0 transition-all duration-200 cursor-pointer ${
                                isActive
                        ...
                        >
                            ...
                            <span className="tracking-tight whitespace-nowrap font-bold text-xs sm:text-sm">{tab.label}</span>
